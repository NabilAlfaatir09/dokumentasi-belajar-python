...
print('Selamat Datang di program ATM, Bank milik kita bersama')
...
while (pilihan == 'y'):
    ...
    if menu == '1':
        ...
        if saldo < 50000:
            ...
            print(
                "Jumlah nominal penarikan sebesar 50000, 100000, 250000, 500000, 1000000")
        ...
        print()
        print("Terima kasih sudah menggunakan layanan BANK Milik kita bersama")
        print()
